...
//         ------------------------- PROPERTY 9 -------------------------
        ...
        Property p9 = Property.builder()
                ...
                .price(parseIndianPrice("₹3.85 Cr"))
                .type("Independent Villa")
                .sqft(4500)
                .reraApproved(true)
...
// ------------------------- PROPERTY 10 -------------------------
        ...
        Property p10 = Property.builder()
                ...
                .price(parseIndianPrice("₹2.6 Cr (Negotiable)"))
                .type("Residential Building")
                .sqft(1000)
                .reraApproved(true)
...
// ------------------------- PROPERTY 11 -------------------------
        ...
        Property p11 = Property.builder()
                ...
                .price(parseIndianPrice("₹1.45 Cr"))
                .type("Apartment")
                .sqft(1680)
                .reraApproved(true)
...
// ------------------------- PROPERTY 12 -------------------------
        ...
        Property p12 = Property.builder()
                ...
                .price(parseIndianPrice("₹32 Lakhs"))
                .type("Studio")
                .sqft(450)
                .reraApproved(false)
...
// ------------------------- PROPERTY 14 -------------------------
        ...
        Property p14 = Property.builder()
                ...
                .price(parseIndianPrice("₹82 Lakhs"))
                .type("Plot")
                .sqft(2400)
                .reraApproved(true)
...
// ------------------------- PROPERTY 15 -------------------------
        ...
        Property p15 = Property.builder()
                ...
                .price(parseIndianPrice("₹56 Lakhs"))
                .type("Apartment")
                .sqft(980)
                .reraApproved(true)
...
// ------------------------- PROPERTY 17 -------------------------
        ...
        Property p17 = Property.builder()
                ...
                .price(parseIndianPrice("₹38 Lakhs"))
                .type("Apartment")
                .sqft(620)
                .reraApproved(true)
...
// ------------------------- PROPERTY 18 -------------------------
        ...
        Property p18 = Property.builder()
                ...
                .price(parseIndianPrice("₹2.95 Cr"))
                .type("Row House")
                .sqft(2560)
                .reraApproved(true)
...
// ------------------------- PROPERTY 19 -------------------------
        ...
        Property p19 = Property.builder()
                ...
                .price(parseIndianPrice("₹68 Lakhs"))
                .type("Apartment")
                .sqft(1150)
                .reraApproved(true)
